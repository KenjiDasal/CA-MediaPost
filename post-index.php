    ...
    <div class="container-fluid">
      <main role="main">
        ...
        <div class="row">
            ...
            <h1>posts
                 <!-- The add button will call posts-create.php, YOU WILL NOW WRITE THE CODE for post-create.php  -->
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <!-- Loop through the following for every item in the $posts[] array, display title, description, author_name etc. to the screen -->
                  <?php foreach ($posts as $post) { ?>
                    <tr>
                      ...
                      <td><?= $post->date ?></td>
                        <td>
                        <?php
                            // We have the img_id for the post, now call findById(img_id) in the class Image.php
                            // Image:: findById($img_id) will go to the database to get the image file from the Image table 
